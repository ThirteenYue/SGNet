...
class SGNet(nn.Module):
    ...
    def forward(self, x, x_seg):
        ...
        mps5 = self.mps5(tda1, tda2_2, tda3_3, tda4_4, encoder_4_down)
        ...
        decoder_1_up = _upsample_like(decoder_1, x)
        ...
        Out = self.outconv(torch.cat((D_5, D_4, D_3, D_2, D_1), dim=1))
        return Out
